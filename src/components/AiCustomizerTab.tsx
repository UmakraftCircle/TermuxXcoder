...
export const AiCustomizerTab: React.FC<AiCustomizerTabProps> = ({
  ...
  return (
    <div className="space-y-4 sm:space-y-6 max-w-5xl mx-auto px-1 sm:px-2 pb-12">
      {/* Header Bento Card */}
      <div className="bg-[#161b22] border border-[#30363d] rounded-2xl p-3.5 sm:p-4 shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div className="flex items-center gap-2.5 w-full sm:w-auto min-w-0">
          <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-[#1f6feb] via-[#a371f7] to-[#238636] p-0.5 shadow-md flex-shrink-0">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5 flex-wrap">
              <h2 className="text-sm sm:text-base font-bold text-[#f0f6fc] truncate font-mono">
                UmaKraft AI Copilot Hub
              </h2>
              <span className="text-[9px] font-mono px-2 py-0.5 rounded-full bg-[#238636]/20 text-[#3fb950] border border-[#238636]/30 font-semibold shrink-0">
                Local + Multi-Cloud
              </span>
            </div>
            <p className="text-[11px] text-[#8b949e] truncate">
              Offline Qwen 1.5 Coder (/models/default.gguf) or cloud engines (Gemini, Groq, OpenAI).
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto pt-1 sm:pt-0 shrink-0">
          <button
            ...
            disabled={isTesting}
            className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 px-3 py-1.5 min-h-[38px] bg-[#21262d] hover:bg-[#30363d] text-[#58a6ff] text-xs font-semibold rounded-xl border border-[#30363d] transition-all disabled:opacity-50 active:scale-95"
          >
          ...
          <button
            ...
            className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 px-3.5 py-1.5 min-h-[38px] bg-[#238636] hover:bg-[#2ea043] text-white text-xs font-bold rounded-xl border border-[#3fb950]/30 shadow-md transition-transform active:scale-95"
          >
      ...
      <div className="flex items-center gap-1.5 p-1 bg-[#161b22] border border-[#30363d] rounded-xl">
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-1.5 py-2 px-3 rounded-lg text-xs sm:text-sm font-bold transition-all min-h-[38px] ${
        ...
        >
          <Download className="h-3.5 w-3.5 text-[#7ee787]" />
          <span>Download AI Models</span>
          <span className="text-[9px] font-mono px-1.5 py-0.2 rounded bg-black/30 text-[#7ee787] border border-[#3fb950]/40 font-bold hidden xs:inline">
            GGUF Free
          </span>
        </button>
      </div>
      ...
      {activeMainSection === 'download_ai' ? (
        ...
        <>
          {/* Status Grid: Workspace Isolation & Turso Memory (Side-by-side or compact) */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
            {/* App Rule: Immutable Edit Scope Lock Banner */}
            <div className="bg-[#161b22] border border-[#1f6feb]/30 rounded-xl p-2.5 sm:p-3 shadow-sm flex items-start gap-2.5 bg-gradient-to-r from-[#1f6feb]/10 via-[#161b22] to-[#161b22]">
              <div className="p-1.5 rounded-lg bg-[#1f6feb]/20 text-[#58a6ff] shrink-0 mt-0.5">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1.5 flex-wrap">
                  ...
                  <span className="text-[8.5px] font-mono px-1.5 py-0.2 rounded-full bg-[#1f6feb]/20 text-[#58a6ff] border border-[#1f6feb]/30 font-semibold">
                    IMMUTABLE
                  </span>
                </div>
                <p className="text-[11px] text-[#8b949e] mt-0.5 leading-snug">
                  AI edits strictly apply to <strong>sandbox/</strong> & <strong>workspace/</strong> files.
                </p>
              </div>
            </div>

            {/* Turso Memory & RAG Status Banner */}
            <div className="bg-[#161b22] border border-[#30363d] rounded-xl p-2.5 sm:p-3 flex items-center justify-between gap-2 shadow-sm">
              <div className="flex items-center gap-2.5 min-w-0">
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-[#00eb87] to-[#0094f7] p-0.5 flex-shrink-0">
                  <div className="h-full w-full bg-[#0d1117] rounded-[6px] flex items-center justify-center">
                    <Database className="h-4 w-4 text-[#00eb87]" />
                  </div>
                </div>
                <div className="min-w-0">
                  <div className="flex items-center gap-1.5">
                    <h4 className="text-xs font-bold text-white font-mono truncate">TURSO RAG MEMORY</h4>
                    <span className="text-[8.5px] px-1.5 py-0.2 rounded-full bg-[#00eb87]/20 text-[#00eb87] border border-[#00eb87]/40 font-bold uppercase shrink-0">
                      Active
                    </span>
                  </div>
                  <p className="text-[10.5px] text-[#8b949e] truncate mt-0.5">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <h3 className="text-xs font-bold text-[#f0f6fc] uppercase tracking-wider font-mono">
              ...
              {(Object.keys(AI_PROVIDERS) as AiProviderType[]).map((provKey) => {
                ...
                return (
                  <button
                    ...
                    className={`p-2.5 rounded-xl border text-left transition-all relative flex flex-col justify-between min-h-[76px] active:scale-[0.98] ${
                      isSelected
                        ? 'bg-[#1f6feb]/15 border-[#58a6ff] text-[#f0f6fc] shadow-md ring-1 ring-[#58a6ff]'
                  ...
                  >
                    <div>
                      <div className="flex items-center justify-between gap-1 mb-1">
                        ...
                        <span
                          className={`text-[8.5px] px-1.5 py-0.2 rounded font-mono font-medium whitespace-nowrap shrink-0 ${prov.badgeColor}`}
                        >
                          {prov.badge}
                        </span>
                      </div>
                      <p className="text-[10px] text-[#8b949e] line-clamp-1 leading-snug">
                        {prov.tagline}
                      </p>
                    </div>

                    <div className="mt-1.5 pt-1 border-t border-[#30363d]/50 flex items-center justify-between text-[9.5px]">
                      <span className="text-[#8b949e]">{prov.requiresKey ? 'Key req.' : 'Offline Free'}</span>
                      {isSelected ? (
